        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              For over a decade, Serenity Resorts has been crafting exceptional experiences 
              across Maharashtra's most beautiful destinations. Our commitment to luxury, 
              sustainability, and authentic hospitality has made us the preferred choice 
              for discerning travelers seeking more than just accommodation.
            </p>
            
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              From the bustling energy of Pune to the serene hills of Lonavala and the 
              pristine nature of Karjat, each of our properties offers a unique gateway 
              to luxury and tranquility.
            </p>

            <div className="grid grid-cols-2 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold text-luxury-earth mb-2">50+</div>
                <div className="text-muted-foreground">Luxury Suites</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-luxury-earth mb-2">10K+</div>
